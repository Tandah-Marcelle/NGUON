          ...
          {impacts.map((impact, i) => (
            <AnimatedSection key={impact.title} delay={i * 0.1}>
              <motion.div
                ...
                className="bg-white dark:bg-card rounded-2xl p-8 shadow-sm border-4 border-transparent transition-all duration-300 hover:border-primary hover:shadow-2xl h-full"
              >
